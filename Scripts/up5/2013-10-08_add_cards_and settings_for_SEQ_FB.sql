...
select gen_id(hibernate_sequence, 1), ou.owner, 'integration_queue_webserver_host', 'IP вебсервиса СУО', null, null from org_unit ou
...
INSERT INTO card_element (id,name,owner,card_code) VALUES ('cause1','Отсутсвие паспорта',null,'STypeCause');
INSERT INTO card_element (id,name,owner,card_code) VALUES ('cause2','Отсутсвие свидетельства о рождении',null,'STypeCause');