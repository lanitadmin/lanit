...
VALUES (nextval('hibernate_sequence'), 'pathReport', 'string', true, 'Путь до печатной формы', 200, NULL, 'RTypeForm', NULL);

INSERT INTO CARD_FIELD (FIELD_ID, FIELD_NAME, FIELD_TYPE, FIELD_VISIBLE, FIELD_CAPTION, FIELD_SIZE, FIELD_IDENT, CARD_CODE, FIELD_REQUIRED)
VALUES (nextval('hibernate_sequence'), 'fromAddress', 'string', true, 'Место назначения', 2047, NULL, 'ROrgFrom', NULL);