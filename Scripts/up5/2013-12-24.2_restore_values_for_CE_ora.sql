...
select hibernate_sequence.nextval, null, field_integer_value, null, card_element_id, (select max(field_id) from card_field where card_code = 'SService' and field_name like 'ecuShow')
