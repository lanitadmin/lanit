...
VALUES (hibernate_sequence.nextval,'ServiceType','integer',1,'Тип услуги',2,null,'SService');
--2)наполение
INSERT INTO CARD_ELEMENT_FIELD_VALUE (ID, FIELD_STRING_VALUE,FIELD_DATE_VALUE,FIELD_INTEGER_VALUE,FIELD_ID,CARD_ELEMENT_ID)
SELECT hibernate_sequence.nextval, null, null, 1, (select field_id from CARD_FIELD where  card_code = 'SService' and field_name = 'ServiceType'), c.id
...
INSERT INTO CARD_FIELD (FIELD_ID,FIELD_NAME,FIELD_TYPE,FIELD_VISIBLE,FIELD_CAPTION,FIELD_SIZE,FIELD_IDENT,CARD_CODE)
VALUES (hibernate_sequence.nextval,'SelectType','integer',1,'Тип выбора дочерних элементов',2,null,'SDocType');
